export default {
  ...
  dialogs: {
    ...
    gitSetup: {
      ...
      discardChangesMessage: 'هل أنت متأكد من أنك تريد تجاهل التغييرات في:',
      discardChangesWarning:
        'سيؤدي هذا إلى إعادة الملف إلى آخر حالة تم الالتزام بها. لا يمكن التراجع عن هذا الإجراء.',
      restoreFile: 'استعادة الملف',
    },
    branch: {
      title: 'الفروع',
      newBranch: 'فرع جديد',
