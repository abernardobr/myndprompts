export default {
  ...
  explorer: {
    ...
    newProjectLibrary: 'New Project Library',
  ...
  dialogs: {
    ...
    exportLibrary: {
      ...
      description: 'Export this project as a library JSON file that can be shared and imported.',
      name: 'Library Name',
      namePlaceholder: 'Enter library name...',
      libraryDescription: 'Description',
      descriptionPlaceholder: 'Describe what this library contains...',
      language: 'Language',
      destinationFolder: 'Destination Folder',
      destinationFolderPlaceholder: 'Select a folder...',
      selectFolder: 'Select Destination Folder',
      export: 'Export',
      saveDialogTitle: 'Save Library',
      success: 'Library exported successfully with {count} items',
      noFilesFound: 'No files found to export in this project',
    },
    newDirectory: {
      title: 'New Directory',
      name: 'Directory Name',
  ...
  ai: {
    ...
    description:
      'Manage your AI models. Add models from different providers and select a default for intelligent features.',
    providers: {
    ...
    messages: {
      ...
      baseUrlUpdated: 'Base URL updated',
      encryptionUnavailable:
        'Secure encryption is not available on this system. Keys will be stored with basic encoding.',
      deleteKeyConfirm:
        'Are you sure you want to delete this API key? This action cannot be undone.',
      noApiKeyRequired: 'No API key required. Make sure the service is running locally.',
      ollamaHint: 'Make sure Ollama is running on this address. Default: http://localhost:11434',
    },
    wizard: {
      title: 'Add Model',
      step1Title: 'Select Provider',
      step1Description: 'Choose an AI provider to add a model from.',
      step2Title: 'API Key',
      step2Description: 'Configure authentication for the selected provider.',
      step3Title: 'Select Model',
      step3Description: 'Choose a model to add to your list.',
      keyAlreadyConfigured: 'API key already configured',
      changeKey: 'Change Key',
      saveAndContinue: 'Save & Continue',
      fetchingModels: 'Fetching available models...',
      fetchError: 'Failed to fetch models. Check your API key and try again.',
    ...
    models: {
      ...
      remove: 'Remove Model',
      removeConfirm: 'Are you sure you want to remove this model?',
      default: 'Default',
      addModel: 'Add Model',
    ...
    chatDefaults: {
      title: 'Chat Defaults',
      description: 'Default settings applied to new chat sessions.',
    },
  },
